...
namespace IBL.BO
{
    ...
    {
        public DroneForList(int id, string model, WeightCategories maxWeight, DroneStatuses status, double batteryStatuses, Location currentLocation, int deliveryId)
        {
            Id = id;
            Model = model;
            MaxWeight = maxWeight;
