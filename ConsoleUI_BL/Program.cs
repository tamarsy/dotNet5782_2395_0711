        ...
        class Program
        {
            ...
            public static void switchAdd(ref IBL.IBL bl)
            {
                ...
                switch (option)
                {
                    ...
                    case Add.Drone:
                        {
                            Console.WriteLine("enter values to drone properties:id, max wheight (0-2), station id, model");
                    ...
                    case Add.Parcel:
                        {
                            Console.WriteLine("enter values to parcel properties: sender id, target id, weigth (0-2), priority (0-2)");
                    ...
                    case Update.CustomerDedails:
                        {
                            ...
                            if (int.TryParse(Console.ReadLine(), out id))
                            {
                                ...
                                bl.UpdateCusomer(id, name: name, phone: phone);
                            }
                            else
                                Console.WriteLine("The conversion failed and therefore the updating was not made");
                            break;
